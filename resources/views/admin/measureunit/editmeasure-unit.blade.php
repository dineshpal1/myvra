...
@section('content')
    ...
    <div class="breadcrumb-area">
        ...
        <ol class="breadcrumb">
            ...
            <li class="item">Edit Measure Unit</li>
        </ol>
    </div>
    <!-- End Breadcrumb Area -->
    <!-- Start -->
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card mb-30">
                ...
                <form id="measure_unit-page" method="POST" action="{{route('measure_unit/edit')}}">
                    {{ csrf_field() }}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input type="hidden" name="id" value="{{$objRecord->id}}">
                                    <input type="text" class="form-control" name="unit_name"
                                        value="{{$objRecord->unit_name}}"
                                        id="unit_name" />
                                    <span class="hasTextErrors"
                                        id="unit_name_error"></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                        ...
                        <button type="button" class="btn btn-primary add_btn"
                            id="measureunitbtn" form_id="measure_unit-page">
