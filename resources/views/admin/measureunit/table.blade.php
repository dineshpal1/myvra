            ...
            <div class="table100 table-admin table-local">
                <table id="mytable">
                    ...
                    <tbody>
                        ...
                        <td class="column4">
                         <select name="unit_to" onchange="convert($(this).val(),'{{$objData->unit_name}}','{{$key}}')" id="to">
                    ...
                    <!--</form>-->
                    <td class="column4" id="result_{{$key}}" >
...
<script>
    function convert(to,value,index){
       // var data={value:value,to:to};
