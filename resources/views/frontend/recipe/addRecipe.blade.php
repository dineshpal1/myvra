...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card mb-30">
            ...
            <form id="vendor-item-page" action="{{route('add-recipe')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" name="recipe_name" id="recipe_name" value="{{old('recipe_name')}}"/>
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="number" class="form-control" name="recipe_yield" id="recipe_yield" value="{{old('recipe_yield')}}"/>
                    ...
                    <div class="col-lg-6">
                     ...
                     <input type="number" class="form-control" name="recipe_batch_cost" value="{{old('recipe_batch_cost')}}" id="recipe_batch_cost"/>
