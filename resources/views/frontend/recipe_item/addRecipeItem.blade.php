...
<div class="breadcrumb-area">
    ...
    <ol class="breadcrumb">
       ...
       @php
        ...
        @endphp</li>
        <li class="item">Add Recipe Items</li>
    </ol>
</div>
<!-- End Breadcrumb Area -->
<!-- Start -->
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card mb-30">
            ...
            <form id="vendor-item-page" action="{{route('add-recipe-item')}}" method="POST" >
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Recipe Item Vendor Name</label>
                                  <input type="text" class="form-control" name="recipe_item_vendor_name" id="recipe_item_vendor_name" value="{{old('recipe_item_vendor_name')}}"/>
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="recipe_item_name" id="recipe_item_name" value="{{old('recipe_item_name')}}"/>
                      ...
                      <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="recipe_item_code" id="recipe_item_code" value="{{old('recipe_item_code')}}"/>
                         @if ($errors->has('recipe_item_name'))
                    ...
                    <div class="col-lg-6">
                     ...
                     <input type="number" class="form-control" name="recipe_item_portion" value="{{old('recipe_item_portion')}}" id="recipe_item_portion"/>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="number" class="form-control" name="recipe_item_yields" value="{{old('recipe_item_yields')}}" id="recipe_item_yields"/>
                        ...
                        <div class="col-lg-6">
                         ...
                         <div class="col-lg-6">
                            <div class="form-group">
                               ...
                               <input type="text" class="form-control" name="recipe_item_type" value="{{old('recipe_item_type')}}" id="recipe_item_type"/>
