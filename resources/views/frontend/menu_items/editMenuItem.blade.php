...
<div class="breadcrumb-area">
    ...
    <ol class="breadcrumb">
       ...
       @php
        ...
        @endphp</li>
        <li class="item">Edit Menu Item</li>
    </ol>
</div>
<!-- End Breadcrumb Area -->
<!-- Start -->
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card mb-30">
            ...
            <form id="vendor-item-page" action="{{route('menu_item_edit')}}" method="POST" >
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="menu" id="menu" >
                                    ...
                                    <option value="{{$menu->id}}" @if ($obj->menu_id==$menu->id) selected @endif>
                                        {{$menu->menu_name}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>vendor</label>
                           <select class="form-control" name="vendor" id="vendor" onchange="renderAjaxContent('{{route('getVendorItemByVendor')}}','#vendor_item',$(this).val(),'{{$obj->vendor_item_id}}')">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>menu_item_vendor_name</label>
                                  <input type="text" class="form-control" name="menu_item_vendor_name" id="menu_item_vendor_name" value="{{old('menu_item_vendor_name',$obj->menu_item_vendor_name)}}"/>
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="menu_item_name" id="menu_item_name" value="{{old('menu_item_name',$obj->menu_item_name)}}"/>
                      ...
                      <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="menu_item_code" id="menu_item_code" value="{{old('menu_item_code',$obj->menu_item_code)}}"/>
                         @if ($errors->has('menu_item_name'))
                    ...
                    <div class="col-lg-6">
                     ...
                     <input type="number" class="form-control" name="menu_item_portion" value="{{old('menu_item_portion',$obj->menu_item_portion)}}" id="menu_item_portion"/>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="number" class="form-control" name="menu_item_yields" value="{{old('menu_item_yields',$obj->menu_item_yield)}}" id="menu_item_yields"/>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                               ...
                               <input type="number" class="form-control" name="cost" value="{{old('cost',$obj->menu_item_cost)}}" id="cost"/>
                                @if ($errors->has('cost'))
                         ...
                         <div class="col-lg-6">
                            <div class="form-group">
                               ...
                               <input type="text" class="form-control" name="menu_item_type" value="{{old('menu_item_type',$obj->menu_item_type)}}" id="menu_item_type"/>
