...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card mb-30">
            ...
            <form id="vendor-item-page" action="{{url('menu/edit',$obj->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="menu_category" id="menu_category_id" >
                                    ...
                                    <option value="{{$objdata->id}}" @if($objdata->id==$obj->menu_category_id)
                                      selected
                                      @endif>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" name="menu_name" id="menu_name" value="{{old('menu_name',$obj->menu_name)}}"/>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Discription</label>
                                 ...
                                 <textarea class="form-control" name="discription" rows="4" cols="50" id="discription" value="{{old('discription',$obj->menu_description)}}">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="number" class="form-control" name="menu_cost" id="menu_cost" value="{{old('menu_cost',$obj->menu_cost)}}"/>
                    ...
                    <div class="col-lg-6">
                     ...
                     <input type="number" class="form-control" name="menu_percent" value="{{old('menu_percent',$obj->menu_cost_percentage)}}" id="menu_percent"/>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="number" class="form-control" name="menu_contribution" value="{{old('menu_contribution',$obj->menu_contribution)}}" id="menu_contribution"/>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                               ...
                               <input type="number" class="form-control" name="selling_price" value="{{old('selling_price',$obj->menu_selling_price)}}" id="selling_price"/>
