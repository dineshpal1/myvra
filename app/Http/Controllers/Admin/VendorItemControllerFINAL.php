      ...
      // dd($array);
       ...
       // die;
        ...
        
        {
           ...
           //echo count($values);die;;
            
            //echo $row[0]['vendor'];die;
           ...
           foreach($values as $item=>$name)
           {
               ...
               $itemCodeName=trim($name['item_code']); 
               ...
               // $vendor_item->measure_unit =$name['unit_of_measure'];
                ...
                $vendor_item->item_code=$name['item_code'];
                $vendor_item->item_title=$name['item_name'];
                $vendor_item->item_price=$name['item_price'];
                $vendor_item->item_description=$name['description'];
                $vendor_item->pack_per_case=$name['pack_per_case'];
                $vendor_item->pack_size=$name['pack_size'];
                $vendor_item->item_catch_weight=$name['catch_weight'];
                $vendor_item->is_active=1;
                   ...
                   $data=$vendor_item->save();
                    ...
                    if ($data){
                    return redirect()->route('vendor-item');
