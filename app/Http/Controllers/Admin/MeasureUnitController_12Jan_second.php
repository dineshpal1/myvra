          ...
          switch($inputFormat)
          {
             case "mm":
                    switch ($outputFormat)
                    {
                      case "mm": $outputNumber = $inputNumber; //mm TO mm
                       ...
                       break;  
                        case "cm":
                         $outputNumber = $inputNumber/10;   //mm TO CM
                        break;
                      case "inches": 
                        $outputNumber = $inputNumber/25.4; //mm TO  INCHES
                      break;
                      case "feet": 
                        $outputNumber = $inputNumber/305; //mm TO FT
                       break;  
                        case "yards": 
                         $outputNumber = $inputNumber/914;     //mm TO yards
                        break;
                         case "meter": 
                        $outputNumber = $inputNumber/1000;     //mm TO METER
                         break; 
                    }
                  //  echo $outputNumber;
            case "cm":
            ...
            case "miligrams":
             ...
             case "pounds":
                    ...
                    break;
                    case "kilogram": $outputNumber = $inputNumber/2.205; //pounds TO kg
                    break;  
                }
             case "ounces":
                   switch ($outputFormat){
             ...
             case "kilogram":
                switch ($outputFormat){
                 ...
                 // return response()->json($outputNumber);
          }
          //echo $outputNumber;
          return response()->json($outputNumber);
        }else{
